          ...
          <div className="flex gap-4 w-full md:w-auto">
             <div className="relative flex-1 md:w-48">
                ...
                <button 
                  ...
                  className="absolute right-2 top-2 bottom-2 px-3 bg-slate-100 hover:bg-purple-500 hover:text-white text-slate-500 rounded-2xl transition-all disabled:opacity-50"
                >
             ...
             <button 
              ...
              className="btn-primary !px-8 flex items-center gap-3 !h-14 !rounded-3xl shadow-xl shadow-purple-500/20"
             >
           ...
           <div className="lg:col-span-2">
              {loading ? (
                <div className="bg-white rounded-[40px] p-20 flex flex-col items-center justify-center border border-slate-100 opacity-30">
                  ...
                  <p className="font-black  tracking-widest text-[10px]">Mapeando regiões...</p>
                </div>
                ...
                <div className="bg-white rounded-[40px] p-20 flex flex-col items-center justify-center border border-slate-100 text-center">
                  ...
                  <h3 className="text-xl font-black text-slate-800  italic-none">Nenhuma Cidade Operacional</h3>
                  ...
                  {filteredCities.map(city => (
                    <div key={city.id} className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-md transition-all group flex items-center justify-between">
                       <div className="flex items-center gap-4">
                          <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all ${city.isActive ? "bg-purple-50 text-purple-500" : "bg-slate-50 text-slate-300"}`}>
                             <Building2 size={24} />
                          </div>
                          <div>
                             <h4 className="font-black text-slate-800  text-xs tracking-tight">{city.name}</h4>
                             <p className="text-[10px] text-slate-400 font-bold  tracking-widest">{city.state}</p>
                          </div>
                       </div>
           ...
           <div className="space-y-6">
              <div className="bg-slate-900 rounded-[40px] p-8 text-white relative overflow-hidden">
                 <div className="relative z-10">
                    ...
                    <h3 className="text-2xl font-black  tracking-tighter leading-none mb-2">Expansão de Mercado</h3>
                    ...
                    <div className="space-y-4">
                       <div className="flex items-center gap-4">
                          <div className="text-2xl font-black text-purple-500">{platformCities.length}</div>
                          <div className="text-[9px] font-black  text-slate-500 tracking-widest">Cidades Ativas</div>
                       </div>
                    </div>
                 </div>
              ...
              <div className="bg-white rounded-[40px] p-8 border border-slate-100">
                 <h4 className="text-xs font-black  text-slate-400 tracking-widest mb-4">Dica de Gestão</h4>
        ...
        <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-md z-[100] flex items-center justify-center p-4">
          <div className="bg-white rounded-[48px] w-full max-w-2xl p-10 lg:p-14 shadow-2xl flex flex-col max-h-[90vh]">
             <div className="flex justify-between items-start mb-8">
                <div>
                  <h2 className="text-3xl font-black text-slate-900  tracking-tighter">Expandir Região</h2>
                  <p className="text-slate-500 text-xs font-bold  tracking-widest mt-1">Busca oficial via IBGE</p>
                </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="md:col-span-1 space-y-2">
                   <label className="text-[10px] font-black text-slate-400  tracking-widest ml-1">Estado (UF)</label>
                   <select 
                ...
                <div className="md:col-span-2 space-y-2">
                   <label className="text-[10px] font-black text-slate-400  tracking-widest ml-1">Cidade Disponível</label>
             ...
             <div className="mt-auto p-6 bg-purple-50 rounded-[32px] border border-purple-100 flex items-center gap-4">
                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-purple-500 shadow-sm font-black">?</div>
                <p className="text-[11px] text-purple-900 font-bold leading-tight">
