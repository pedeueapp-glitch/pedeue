      ...
      <div className="p-6 lg:p-10 max-w-7xl mx-auto w-full">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
          ...
          <button 
            ...
            className="btn-primary !px-6 flex items-center gap-2 !h-12 !rounded-2xl shadow-lg shadow-purple-500/20"
          >
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-32 opacity-20">
            ...
            <p className="font-black  tracking-widest text-xs">Carregando usuários...</p>
          </div>
        ) : (
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-100">
                    <th className="px-8 py-6 text-[10px] font-black text-slate-400  tracking-widest">Usuário</th>
                    <th className="px-8 py-6 text-[10px] font-black text-slate-400  tracking-widest text-center">Nível</th>
                    <th className="px-8 py-6 text-[10px] font-black text-slate-400  tracking-widest">Loja Vinculada</th>
                    <th className="px-8 py-6 text-[10px] font-black text-slate-400  tracking-widest text-right pr-12">Ações</th>
                  </tr>
                </thead>
                    ...
                    <tr key={user.id} className="hover:bg-slate-50/50 transition-colors group">
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-500 group-hover:bg-purple-50 group-hover:text-purple-500 transition-all">
                             <Users size={18} />
                          </div>
                          <div>
                             <div className="font-black text-slate-800  text-xs">{user.name}</div>
                      ...
                      <td className="px-8 py-6 text-center">
                         <div className="flex justify-center">
                           <div className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-[9px] font-black  tracking-widest border ${user.role === 'SUPERADMIN' ? "bg-purple-50 text-purple-600 border-purple-200" : user.role === 'ADMIN' ? "bg-blue-50 text-blue-600 border-blue-200" : "bg-slate-50 text-slate-500 border-slate-200"}`}>
                      ...
                      <td className="px-8 py-6 text-right pr-12">
                        <div className="flex justify-end gap-2">
                           <button 
                             ...
                             className="p-3 text-slate-400 hover:text-purple-500 hover:bg-purple-50 rounded-2xl transition-all border border-transparent hover:border-purple-100"
                           >
                             <Settings size={20} />
                           </button>
                           <button 
        ...
        <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-md z-[100] flex items-center justify-center p-4">
          <form onSubmit={saveUser} className="bg-white rounded-[48px] w-full max-w-md p-10 lg:p-14 shadow-2xl flex flex-col">
            <div className="mb-8 text-center md:text-left">
              ...
              <p className="text-slate-500 text-xs font-bold  tracking-widest mt-1">Defina permissões e acessos</p>
            </div>
            
            <div className="space-y-5 mb-10 text-left">
              <div className="space-y-1">
                <label className="text-[10px] font-black text-slate-400  ml-1">Nome Completo</label>
                <input className="input-field" required value={form.name} onChange={e => setForm({...form, name: e.target.value})} />
              </div>
              <div className="space-y-1">
                <label className="text-[10px] font-black text-slate-400  ml-1">E-mail de Acesso</label>
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-black text-slate-400  ml-1">Nível de Permissão</label>
            ...
            <div className="flex gap-4">
              ...
              <button type="submit" disabled={saving} className="btn-primary flex-[2] shadow-purple-500/20">
